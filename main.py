...
from PyQt6.QtWidgets import QApplication, QGridLayout, QLabel, \
    QDialog, QWidget, QLineEdit, QMainWindow, QTableWidget, QTableWidgetItem, QVBoxLayout, QComboBox, QPushButton, \
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        search_action.triggered.connect(self.searching)
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """ 
        This App is created in training programm
        """
...
class EditDialog(QDialog):
    def __init__(self):
        ...
        # Add student name to the widget
